...
docker build -t server-part ./parse-ubuntu-instance/by_docker/docker_run/serv/Dockerfile
docker build -t dashboard-part ./parse-ubuntu-instance/by_docker/docker_run/dash/Dockerfile
